"""Pre-compute and cache LLM embeddings for the FULL (un-subsampled) tables."""
...
def run_model(
    ...
    # Preliminaries
    model_name = method
    llm_embed_folder = f'{path_configs["base_path"]}/data/llm_embeding_FULL/{model_name}'
    ...
    time_folder = f'{path_configs["base_path"]}/data/llm_embed_time_FULL/{model_name}'
    ...
    # Load data
    data_folder = f"{path_configs['path_data_processed']}_FULL"
