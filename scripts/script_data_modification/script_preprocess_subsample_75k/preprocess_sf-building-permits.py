...
data_path = f"{path_configs['ttb_datasets']}/paper_datasets/regression/sf_permit_time_data.csv"
...
existing_data_path = f"{path_configs['path_data_processed']}/sf-building-permits/data.parquet"
...
data_filename = 'sf-building-permits-FULL'
