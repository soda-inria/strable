...
filename = 'aijob_ai-ml-ds-salaries' # Change the filename accordingly
...
data.groupby(['work_year', 'experience_level', 'employment_type', 'job_title',
        'employee_residence',
       'remote_ratio', 'company_location', 'company_size'])['salary_in_usd'].nunique()

# noticed we have twice the salary for the same partition, so i aggregate
# data = data.groupby(['work_year', 'experience_level', 'employment_type', 'job_title'
#         'employee_residence', 'remote_ratio', 'company_location', 'company_size'], as_index=False).agg({'salary':'mean'})

data.groupby(['work_year', 'experience_level', 'employment_type', 'job_title', 'salary_currency',
        'employee_residence', 'remote_ratio', 'company_location', 'company_size'])['salary_in_usd'].nunique().value_counts()
