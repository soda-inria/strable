"""Re-runs pipelines on full-size tables (skips the 75 K-row cap).
"""
...
from src.encoding_FULL import embed_table
...
def run_model(
    ...
    # Set preliminaries
    # Configs
    config_path = f"{path_configs['path_data_processed']}_FULL/{data_name}/config.json"
