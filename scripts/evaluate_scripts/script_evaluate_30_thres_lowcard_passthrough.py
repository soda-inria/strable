"""Cardinality-threshold ablation: low-cardinality columns -> passthrough.
"""
...
def run_model(
    ...
    if estim_method in ["ridge", "tabm", "realmlp"]:
        ...
        pass
    elif estim_method == "xgb" and isinstance(X_train, pd.DataFrame):
