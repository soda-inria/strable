"""Target-transform ablation: skewness-minimising inverse transform on regression targets.
"""
...
from src.encoding_skew import embed_table
...
def run_model(
    ...
    # Configs
    config_path = f"{path_configs['path_data_processed']}_skewness_inverse_transformation/{data_name}/config.json"
