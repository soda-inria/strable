"""Feature-engineering ablation: hand-engineered features on top of raw tables.
"""
...
from src.encoding_feature_eng import embed_table
...
def run_model(
    ...
    # Configs
    config_path = f"{path_configs['path_data_processed']}_feature_eng/{data_name}/config.json"
