"""Preprocess institute-museum-library-service_discretionary-grant.
The task is to predict the amount of grant awarded. (regression)
refer to https://www.imls.gov/research-evaluation/data/administrative-discretionary-grant-data
"""
...
filename = 'imls/DiscGrants96to13.csv'
...
drop_col = []
drop_col.append('AwardOrig') # Leakage
drop_col.append('ReqAwardAmount') # Leakage
drop_col.append('ReqMatchAmount') # Leakage
drop_col.append('AppMatchAmount') # Leakage
...
data_filename = 'discretionary-grant'
