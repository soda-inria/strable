"""
Preprocess osha accidents dataset
...
filename = 'textTabBench/OSHA HSE DATA_ALL ABSTRACTS 15-17_FINAL.csv' # Change the filename accordingly
...
drop_col = []
drop_col.append('task_assigned') # duplicate column with the target
