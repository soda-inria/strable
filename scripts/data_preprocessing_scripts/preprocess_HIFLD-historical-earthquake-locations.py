"""Preprocess HIFLD historical earthquake locations.
The task is to predict Damage Description (total) (classification) 
"""
...
filename = 'HIFLD/Significant_Earthquakes_4242783775604948785.csv'
...
## Set metadata
target_name = 'Damage Description (total)'
...
drop_col = []
# Leakage
drop_col.append('Damage Amount Order (total)')
drop_col.append('Damage Amount Order')
drop_col.append('Damage Description')
drop_col.append('Damage in Millions of Dollars (total)')
drop_col.append('Damage in Millions of Dollars')
# Highly related
...
data_filename = 'historical-earthquake-locations'
