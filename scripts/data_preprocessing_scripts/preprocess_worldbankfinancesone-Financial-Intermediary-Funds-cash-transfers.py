"""Preprocess worldbankfinancesone-financial-intermediary-funds-cash-transfers.
...
filename = 'worldbankfinancesone/financial_intermediary_funds_cash_transfers_07-13-2025.csv'
...
# Target engineering (per ten thousand)
data[target_name] = data[target_name] / 10000
...
data_filename = 'financial-intermediary-funds-cash-transfers'
