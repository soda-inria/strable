"""
Preprocess beer dataset (from textTabBench)
The task is to predict review_overall (regression)
"""
...
filename = 'textTabBench/beer_profile_and_ratings.csv' # Change the filename accordingly
...
drop_col = []
drop_col.append('review_taste')
drop_col.append('review_palate')
drop_col.append('review_aroma')
drop_col.append('review_appearance')
