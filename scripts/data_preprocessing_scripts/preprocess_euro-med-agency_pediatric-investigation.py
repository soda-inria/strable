"""Preprocess euro-med-agency_paediatric-investigation-plan.
The task is to predict the decision of a plan. (classification)
...
filename = 'european-medicine-agency/paediatric_investigation_plans.csv' # Change the filename accordingly
...
# Target engineering
data.loc[data[target_name].str.contains('refusal'), target_name] = 'R: decision refers to a refusal'
...
data_filename = 'paediatric-investigation-plan'
