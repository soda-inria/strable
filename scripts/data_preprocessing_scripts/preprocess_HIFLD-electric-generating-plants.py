"""Preprocess HIFLD electric-generating-plants.
The task is to predict NET_GEN (regression) 
"""
...
filename = 'HIFLD/Power_Plants_gdb_-7934110650112012255.xlsx'
...
data_filename = 'electric-generating-plants'
