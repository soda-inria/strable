"""
Preprocess wine dataset (from textTabBench)
...
filename = 'textTabBench/WineDataset.csv' # Change the filename accordingly
...
data[target_name] = data[target_name].str.replace(r'[^0-9\.-]', '', regex=True).astype(float)
