"""Preprocess institute-museum-library-service_museums
The task is to predict the revenue of museums.
data guide: https://www.imls.gov/sites/default/files/museum_data_file_documentation_and_users_guide.pdf 
"""
...
# the dataset does not have missing values but spaces ' '.  we encode spaces as NaN.
...
drop_col = []
drop_col.append('INCOMECD15') # Leakage
drop_col.append('INCOME15') # Leakage
