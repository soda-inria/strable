"""Preprocess HIFLD Historic perimeters wildfires dataset.
The task is to predict gisacres (regression) 
"""
...
filename = 'HIFLD/Historic_Geomac_Perimeters_Combined_2000_2018_7623284232327154878.csv'
...
drop_col = []
# Leakage
drop_col.append('shape__Area')
drop_col.append('shape__Length')
# Highly related
...
data_filename = 'historic-perimeters-wildfires'
