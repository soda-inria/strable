"""Preprocess worldbankfinancesone-IFC-advisory-services-projects dataset.
The task is to predict the Estimated Total Budget ($) (regression)
"""
...
filename = 'worldbankfinancesone/ifc_advisory_services_projects_07-13-2025.csv'
...
## Set metadata
target_name = 'Estimated Total Budget ($)'
task = 'regression'
task_type = 'wide'
...
data_filename = 'ifc-advisory-services-projects'
