"""Preprocess worldbankfinancesone-Recipient-executed-Grants-Commitments-Disbursements.
...
filename = 'worldbankfinancesone/recipient_executed_grants_commitments_and_disbursements_07-12-2025.csv'
...
## Set metadata
target_name = 'Disbursements USD (Trust funds)'
task = 'regression'
task_type = 'wide'
...
data_filename = 'recipient-executed-grants-commitments-disbursements'
