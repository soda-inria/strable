"""Preprocess Consumer-Financial-Protection-Bureau-prepaid-financial-product
The task is to predict current_status (classification)
"""
...
filename = 'Consumer Financial Protection Bureau/prepaid_metadata_recent_agreements.csv'
...
drop_col = []
drop_col.append('withdrawal_date')
...
data_filename = 'prepaid-financial-product'
