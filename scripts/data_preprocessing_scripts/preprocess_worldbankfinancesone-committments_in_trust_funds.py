"""Preprocess worldbankfinancesone-commitments-in-trust-funds.
...
filename = 'worldbankfinancesone/commitments_in_trust_funds_07-13-2025.csv'
...
## Set metadata
target_name = 'New Commitments (US$)'
task = 'regression'
task_type = 'wide'
...
data_filename = 'commitments-in-trust-funds'
