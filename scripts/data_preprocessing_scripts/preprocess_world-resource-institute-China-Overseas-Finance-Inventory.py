"""Preprocess World Resource Institute - China Overseas Finance Inventory.
The task is to predict the capacity. (regression)
refer to 
"""
...
filename = 'world_resource_institute/COFI Database Version 2.2 - October 2023.xlsx' # Change the filename accordingly
...
## Set metadata
target_name = 'installed_capacity'
task = 'regression'
task_type = 'wide'
...
data_filename = 'china-overseas-finance-inventory'
