...
folder = f"{path_configs['base_path']}/data/data_processed/"
len(glob(f'{folder}*'))
...
data_path = f"{path_configs['base_path']}/data/data_raw/doe_eligibility/fy2025_master_eligibility_spreadsheet-forpublic.xlsx"
