"""Preprocess summary of deposit - wide.
The task is to predict the deposit of the institution.(regression)
guide: https://www.kaggle.com/datasets/pablomarenco19/summary-of-deposits-fdic
The data is branch-level. Each row represents a branch office of a bank (insured institution) in that year, summarizing its deposits.
"""
...
filename = 'fdic_sod/SOD_CustomDownload_ALL_2024_06_30.csv' # Change the filename accordingly
...
drop_col = []
drop_col.append('ASSET') # Leakage
drop_col.append('DEPDOM') # Leakage
drop_col.append('DEPSUMBR') # Leakage
...
data_filename = 'summary-of-deposit_wide'
