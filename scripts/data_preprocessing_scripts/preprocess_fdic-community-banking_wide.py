"""Preprocess community banking FDIC - wide.
The task is to predict the loan asset ratio.
guide: 
"""
...
filename = 'fdic_communitiy_banking_ref/Historical_Community_Banking_Reference_Data_2019_To_2023.CSV'
...
# Take the last unique ids to prevent leakage
data.sort_values(by='CALLYM', ascending=True, inplace=True)
...
data_filename = 'community-banking_wide'
