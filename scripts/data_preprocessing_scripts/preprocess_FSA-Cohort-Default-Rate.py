"""Preprocess cohort default rate.
The task is to predict Default Rate 1 (classification).
"""
...
filename = 'fsa_height_cash/PEPS300ReportFY21Official.xlsx' # Modified for faster loading
data_path = f'{path_configs['base_path']}/data/data_raw/{filename}'
data = pd.read_excel(data_path, sheet_name='Eligible Schools File', header=0)
...
## Set metadata
target_name = 'Average or Greater than 30'
...
drop_col = []
# Leakage columns
drop_col.append('Num 1')
drop_col.append(' Num 2')
drop_col.append(' Num 3')
drop_col.append(' Denom 1')
drop_col.append('Denom 2')
drop_col.append('Denom 3')
drop_col.append('Default Rate 1')
drop_col.append('Default Rate 2')
drop_col.append('Default Rate 3')
...
data_filename = 'cohort-default-rate'
