...
filename = 'fda/drug-shortages.json' # Change the filename accordingly
...
temp[temp == 'Limited Availablity'] = 'Limited Availability'
temp[temp == 'Limited Availabiltiy'] = 'Limited Availability'
temp[temp == 'Information pending'] = np.nan
temp[temp == 'Available, December 2025'] = np.nan
...
drop_col = []
drop_col.append('shortage_reason') # leakage
drop_col.append('update_type') # leakage
drop_col.append('update_date') # leakage
drop_col.append('related_info') # leakage
drop_col.append('related_info_link') # leakage
drop_col.append('change_date') # leakage
