...
filename = 'fda/device-pma.json' # Change the filename accordingly
...
# Target engineering
data = data[data[target_name].isin(['APPR', 'OK30'])]
data.reset_index(drop=True, inplace=True)
...
drop_col = []
# Leakage columns
drop_col.append('supplement_type')
drop_col.append('supplement_reason')
drop_col.append('supplement_number')
drop_col.append('ao_statement')
