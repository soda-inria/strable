"""Preprocess medicaid ACA federal upper limits dataset - wide
The task is to predict the ACA Full (regression).
"""
...
filename = 'medicaid/aca-federal-upper-limits-06272025.csv'
...
drop_col = []
drop_col.append('Weighted Average of AMPs') # leakage
...
data_filename = 'aca-federal-upper-limits-wide'
