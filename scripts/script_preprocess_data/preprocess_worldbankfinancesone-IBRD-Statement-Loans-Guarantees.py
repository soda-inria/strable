"""Preprocess worldbankfinancesone-IBRD Statement Of Loans and Guarantees.
...
filename = 'worldbankfinancesone/ibrd_statement_of_loans_and_guarantees_latest_available_snapshot_07-14-2025.csv'
...
data_filename = 'ibrd-statement-loans-guarantees'
