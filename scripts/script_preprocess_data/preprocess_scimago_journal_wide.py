"""Preprocess Journal Ranking (SCIMAGO) - Wide.
The task is to predict the H index of journals.
guide: https://www.scimagojr.com/help.php#understand_journals
"""
...
filename = 'journal_sjr/scimagojr 2024.csv' # Change the filename accordingly
...
drop_col.append('SJR Best Quartile')
drop_col.append('Citations / Doc. (2years)')
drop_col.append('Total Citations (3years)')
drop_col.append('SJR')
drop_col.append('Total Docs. (2024)')
drop_col.append('Total Docs. (3years)')
drop_col.append('Ref. / Doc.')
drop_col.append('Citable Docs. (3years)')
...
data_filename = 'journal-ranking_wide'
