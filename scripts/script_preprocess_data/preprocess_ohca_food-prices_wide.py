"""Preprocess food prices (OHCA) - Wide.
The task is to predict usdprice. (regression)
guide: 
"""
...
filename = 'temp_ohca_food_price/wfp_food_prices_global_2024.csv' # Change the filename accordingly
...
# Group-by over the year; exclude price for leakage
data['price'] = data['price'].astype('float32')
data['usdprice'] = data['usdprice'].astype('float32')
data['latitude'] = data['latitude'].astype('float32')
data['longitude'] = data['longitude'].astype('float32')
groupby_col = [
    'countryiso3', 'admin1', 'admin2', 'market', 'market_id',
...
data_filename = 'food-prices_wide'
