"""Preprocess World Resource Institute - US School Bus Fleet.
The task is to predict whether the age of buses are known. (classification)
refer to 
"""
...
# Saved a reduced data that contains the age information
# filename = 'world_resource_institute/Dataset of U.S. School Bus Fleets_FULL_v3_2024-05-10.xlsx' # Change the filename accordingly
# data = pd.read_excel(data_path, sheet_name='Compiled bus-level data')
filename = 'world_resource_institute/us-bus-fleets_reduced.csv' # Modified for faster loading
...
drop_col = []
drop_col.append('Year for summary sheets') # Leakage
...
data_filename = 'us-school-bus-fleet'
