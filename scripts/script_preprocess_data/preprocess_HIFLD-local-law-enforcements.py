"""Preprocess HIFLD local law enforcements dataset.
The task is to predict number_of_officers (regression) 
"""
...
filename = 'HIFLD/Local_Law_Enforcement_Locations_5984871431778011964.xlsx'
...
## Set metadata
target_name = 'number_of_officers'
task = 'regression'
task_type = 'wide'
source = 'HIFLD'
...
data_filename = 'local-law-enforcements'
