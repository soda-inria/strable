"""Preprocess commonlit_clear-corpus."""
...
filename = 'carte/commonlit_clear-corpus.csv' # Change the filename accordingly
...
drop_col = []
drop_col.append('BT s.e.') #leakage
drop_col += [col for col in data.columns if 'Place_pred' in col] #competition predictions
drop_col.append('Kaggle split') 
