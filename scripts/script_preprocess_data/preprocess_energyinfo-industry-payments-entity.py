"""Preprocess energyinfo-industry-payments-entity.
The task is to predict entityPayment (regression)
"""
...
filename = 'energyinfo/entity.csv'
...
data_filename = 'industry-payments-entity'
