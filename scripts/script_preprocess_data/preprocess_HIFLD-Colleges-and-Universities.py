"""Preprocess HIFLD Colleges and Universities dataset.
The task is to predict ratio of enrollment to employment RATIO_ENROLL_EMP (regression) 
"""
...
filename = 'HIFLD/Colleges_and_Universities_-3122497483864735259.csv'
...
drop_col = []
drop_col.append('FT_ENROLL')
drop_col.append('PT_ENROLL')
...
data_filename = 'colleges-and-universities'
