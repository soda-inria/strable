"""Preprocess Media Ranking (SCIMAGO) - wide.
The task is to predict the overall score of the media. (regression)
guide: 
"""
...
filename = 'media_ranking/SCImago Media Ranking_2025_Summer.xlsx' # Change the filename accordingly
...
drop_col = []
drop_col.append('Global_rank') # Leakage
...
data_filename = 'media-ranking_wide'
