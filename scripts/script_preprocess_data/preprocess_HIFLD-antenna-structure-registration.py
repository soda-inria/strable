"""Preprocess HIFLD antenna structure registration dataset.
The task is to predict Strucht (regression) 
"""
...
filename = 'HIFLD/Antenna_Structure_Registration_(ASR).csv'
...
data_filename = 'antenna-structure-registration'
