"""Preprocess medicaid MLR-Summary-Reports.
The task is to predict the Adjusted MLR (regression).
"""
...
filename = 'medicaid/mlr-public-use-file-07302024final.csv'
...
data_filename = 'mlr-summary-reports'
