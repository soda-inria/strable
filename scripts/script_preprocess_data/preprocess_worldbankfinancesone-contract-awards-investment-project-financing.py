...
col1 = 'Supplier Contract Amount (US$)'
col2 = 'Supplier Contract Amount (USD)'
data = data.dropna(subset=[col1, col2], how='all').reset_index(drop=True)
...
data_filename = 'contract-awards-investment-project-financing'
