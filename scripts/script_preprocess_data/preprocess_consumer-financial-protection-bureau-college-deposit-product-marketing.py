"""Preprocess Consumer-Financial-Protection-Bureau-college-deposit-product-marketing
The task is to predict TOTAL_ACTIVE_ACCOUNTS_ (regression)
"""
...
filename = 'Consumer Financial Protection Bureau/cfpb_college-banking-database_2020-2023.csv'
...
## Set metadata
target_name = 'TOTAL_ACTIVE_ACCOUNTS_'
task = 'regression'
task_type = 'wide'
...
data[target_name] = data[target_name].replace('.', np.nan)
if task == 'regression':
...
data_filename = 'college-deposit-product-marketing'
