"""
Preprocess california houses (from textTabBench)
The task is to predict Total interior livable area (regression)
"""
...
filename = 'textTabBench/cf_house_train.csv' # Change the filename accordingly
...
data_filename = 'california-houses'
