"""Preprocess worldbankfinancesone-MIGA-Issued-Projects
The task is to predict Gross Issued Amount (US$) (regression)
"""
...
filename = 'worldbankfinancesone/miga_issued_projects_07-13-2025.csv'
...
## Set metadata
target_name = 'Gross Issued Amount (US$)'
task = 'regression'
task_type = 'wide'
...
data_filename = 'miga-issued-projects'
