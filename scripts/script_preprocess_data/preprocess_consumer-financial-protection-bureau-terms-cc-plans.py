"""Preprocess Consumer-Financial-Protection-Bureau-Terms-CC-Plans
The task is to predict APR (regression)
"""
...
filename = 'Consumer Financial Protection Bureau/TCCP Surveys.csv'
