"""Preprocess lending-club-loan dataset
The task is to predict loan_status (classification) 
"""
...
filename = 'textTabBench/Lending-Club-Loan-Dataset-2007_2011.csv' # Change the filename accordingly
...
data = data[data[target_name] != 'Current']
data.reset_index(drop=True, inplace=True)
...
# Leakage columns
drop_col = []
drop_col.append('last_pymnt_d')
drop_col.append('total_pymnt')
drop_col.append('total_pymnt_inv')
drop_col.append('total_rec_prncp')
drop_col.append('total_rec_int')
drop_col.append('last_credit_pull_d')
drop_col.append('last_pymnt_amnt')
drop_col.append('recoveries')
drop_col.append('collection_recovery_fee')
drop_col.append('total_rec_late_fee')
drop_col.append('mths_since_last_delinq')
...
data_filename = 'lending-club-loan'
