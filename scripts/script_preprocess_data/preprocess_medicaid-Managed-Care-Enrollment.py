...
filename = 'medicaid/managed-care-enrollment-by-program-and-plan2022.csv'
...
drop_col = []
drop_col = [col for col in data.columns if 'Enrollment' in col]
...
data_filename = 'managed-care-enrollment'
