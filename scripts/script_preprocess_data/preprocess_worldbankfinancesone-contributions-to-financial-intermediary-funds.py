"""Preprocess worldbankfinancesone-contributions-to-financial-intermediary-funds.
The task is to predict New Commitments (US$) (regression)
"""
...
filename = 'worldbankfinancesone/contributions_to_financial_intermediary_funds_07-12-2025.csv'
...
drop_col = []
# Leakage
drop_col.append('Receipt Amount (in receipt currency)')
# Highly related
...
data_filename = 'contributions-to-financial-intermediary-funds'
