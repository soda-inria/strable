"""Preprocess energyinfo-global-dams-database.
The task is to predict Res_capacityM3 (regression)
"""
...
filename = 'energyinfo/globaldamsdatabase_global_coverage_november_2020.csv'
...
data_filename = 'global-dams-database'
