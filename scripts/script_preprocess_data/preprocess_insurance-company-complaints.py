"""
Preprocess insurance company complaints (from textTabBench)
The task is to predict Recovery (regression)
"""
...
filename = 'textTabBench/Insurance_Company_Complaints__Resolutions__Status__and_Recoveries.csv' # Change the filename accordingly
...
data_filename = 'insurance-company-complaints'
