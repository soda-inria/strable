"""Preprocess worldbankfinancesone-Corporate-Procurement-Contract-Awards.
The task is to predict the contract award amount.
"""
...
filename = 'worldbankfinancesone/corporate_procurement_contract_awards_07-12-2025.csv'
...
## Set metadata
target_name = 'Contract Award Amount (USD)'
task = 'regression'
task_type = 'wide'
...
data_filename = 'corporate-procurement-contract-awards'
