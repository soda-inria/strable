"""Preprocess HIFLD transmission towers dataset.
The task is to predict SupStruc (regression).
"""
...
filename = 'HIFLD/Transmission_Towers_reduced.csv'
...
data_filename = 'transmission-towers'
