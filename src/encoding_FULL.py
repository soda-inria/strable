...
def prepare_llm(X_train, X_test, data_name, llm_model_name, normalization, n_dimensions=30):
    ...
    # Encode
    cached_llm_embedding_path = f"{path_configs['base_path']}/data/llm_embeding_FULL/{llm_model_name}/{llm_model_name}|{data_name}.parquet"
    ...
    # Extraction time
    time_folder = f"{path_configs['base_path']}/data/llm_embed_time_FULL/{llm_model_name}"
