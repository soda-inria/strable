...
df_private = pd.read_csv(private, low_memory=False)
df_public = pd.read_csv(public, low_memory=False)
data = pd.concat([df_private, df_public], axis=0)
...
data = data[data['Full Time Teachers']>0].reset_index(drop=True)
