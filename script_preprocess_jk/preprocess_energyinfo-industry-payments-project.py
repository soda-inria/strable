"""Preprocess energyinfo-industry-payments-project.
The task is to predict projectPayment (regression)
"""
...
filename = 'energyinfo/project.csv'
...
data_filename = 'industry-payments-project'
