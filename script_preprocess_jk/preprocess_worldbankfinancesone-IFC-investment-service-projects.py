"""Preprocess worldbankfinancesone-IFC-investment-service-projects dataset.
The task is to predict the Total IFC investment as approved by Board(Million - USD) (regression)
"""
...
filename = 'worldbankfinancesone/ifc_investment_services_projects_07-12-2025.csv'
...
## Set metadata
target_name = 'Total IFC investment as approved by Board(Million - USD)'
task = 'regression'
task_type = 'wide'
...
drop_col = []
# Leakage
drop_col += [col for col in data.columns if 'Million - USD' in col]
...
data_filename = 'ifc-investment-service-projects'
