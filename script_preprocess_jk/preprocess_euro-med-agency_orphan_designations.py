"""Preprocess euro-med-agency_orphan-designations.
The task is to predict whether the status of an orphan drug is positive. (classification)
...
filename = 'european-medicine-agency/orphan_designations.csv' # Change the filename accordingly
...
# Target engineering
data.loc[data[target_name] != 'Positive', target_name] = 'Non-Positive'
...
data_filename = 'orphan-designations'
