"""Preprocess meta-critic_whisky dataset."""
...
filename = 'carte/meta-critic_whisky.csv' # Change the filename accordingly
...
drop_col = []
drop_col.append('STDEV') # leakage column
drop_col.append('#') # leakage column
...
data_filename = 'meta-critic_whisky'
