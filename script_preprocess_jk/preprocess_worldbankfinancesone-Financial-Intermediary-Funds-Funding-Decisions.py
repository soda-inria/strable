...
## | Use Code                  | 'Projects', 'Projects', 'Projects'    | —                             |
## | Country Beneficiary       | 'Swaziland', 'Swaziland', 'Iran, Is...| —                             |
## | Recipient                 | 'Nat'l. Emer. Response Counc...', '...| —                             |
## | Sub Account               | 'ADPT', 'ADPT', 'ADPT'                | —                             |
## | Approval Quarter          | 'JAN-MAR', 'OCT-DEC', 'APR-JUN'       | —                             |
