"""Preprocess medicaid first time NADAC Rates.
The task is to predict nadac rate (regression).
"""
...
filename = 'medicaid/first-time-nadac-rates-06182025.csv'
...
data_filename = 'first-time-nadac-rates'
