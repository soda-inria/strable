"""Preprocess HIFLD historical volcanic locations.
The task is to predict DEATHS_TOTAL_DESCRIPTION (classification) 
"""
...
filename = 'HIFLD/Significant_Volcanic_Events_7560138930245207266.xlsx'
...
## Set metadata
target_name = 'DEATHS_TOTAL_DESCRIPTION'
...
drop_col = []
# Leakage
drop_col.append('DEATHS_AMOUNT_ORDER_TOTAL')
drop_col.append('DEATHS_DESCRIPTION')
drop_col.append('DEATHS_AMOUNT_ORDER')
drop_col.append('FATALITIES')
drop_col.append('DEATHS')
drop_col.append('DEATHS_TOTAL')
# Highly related
...
data_filename = 'historical-volcanic-locations'
