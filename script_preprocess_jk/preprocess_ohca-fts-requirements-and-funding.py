"""Preprocess ohca-fts-requirement-and-funding.
...
filename = 'temp_ohca_funding/fts_requirements_funding_globalcluster_global.csv'
...
data_filename = 'fts-requirement-and-funding'
