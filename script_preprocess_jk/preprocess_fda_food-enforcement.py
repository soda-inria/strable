...
filename = 'fda/food-enforcement.json' # Change the filename accordingly
...
# Target engineering
data = data[data[target_name] != 'Not Yet Classified']
data.reset_index(drop=True, inplace=True)
...
data_filename = 'food-enforcement'
