"""Preprocess fda_tobacco-problem."""
...
filename = 'fda/tobacco-problem.json' # Change the filename accordingly
...
## Set metadata
target_name = 'number_health_problems'
...
drop_col = []
drop_col.append('reported_health_problems')
