"""Preprocess HRSA medically underserved areas populations.
The task is to use IMU score to classify medically underserved areas:IMU score of 62 determines the Medically underserved.
"""
...
filename = 'health_resources_and_service_administration/MUA_DET.xlsx'
data_path = f"{path_configs['base_path']}/data/data_raw/{filename}"
data = pd.read_excel(data_path, sheet_name='MUA_DET')
...
drop_col = []
drop_col.append('Percent of Population with Incomes at or Below 100 Percent of the U.S. Federal Poverty Level')
drop_col.append('Percent of Population with Incomes at or Below 100 Percent of the U.S. Federal Poverty Level Index of Medical Underservice Score')
drop_col.append('Percentage of Population Age 65 and Over')
drop_col.append('Percentage of Population Age 65 and Over IMU Score')
drop_col.append('Infant Mortality Rate')
drop_col.append('Infant Mortality Rate IMU Score')
drop_col.append('Providers per 1000 Population')
drop_col.append('Ratio of Providers per 1000 Population IMU Score')
...
data_filename = 'medically-underserved-areas-populations'
