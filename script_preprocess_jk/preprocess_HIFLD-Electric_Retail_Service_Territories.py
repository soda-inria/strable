"""Preprocess HIFLD Electric Retail Service Territories dataset.
The task is to predict TOTAL_MWH.
"""
...
filename = 'HIFLD/Electric_Retail_Service_Territories.csv'
...
drop_col = []
# Leakage
drop_col += [col for col in data.columns if 'MWH' in col]
drop_col.remove(target_name)
drop_col.append('NET_GEN')
drop_col.append('PURCHASED')
# Highly related
drop_col.append('CUSTOMERS')
drop_col.append('WINTR_PEAK')
drop_col.append('SUMMR_PEAK')
drop_col.append('WINTER_CAP')
drop_col.append('SUMMER_CAP')
...
data_filename = 'electric-retail-service-territories'
