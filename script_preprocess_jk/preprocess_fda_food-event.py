...
filename = 'fda/food-event.json' # Change the filename accordingly
...
# Target engineering
# We are interested in customers who have visited a healthcare facility
# Hospitalization, Visited Emergency Room, Visited a Health Care Provider
data.dropna(subset=target_name, inplace=True)
data.reset_index(drop=True, inplace=True)
mask = data[target_name].str.contains('Visited')
data = data[mask]
data.reset_index(drop=True, inplace=True)
temp = data[target_name].copy()
temp[temp.str.contains('Hospitalization')] = 'Hospitalization'
temp[temp.str.contains('Visited Emergency Room')] = 'Visited Emergency Room'
temp[temp.str.contains('Visited a Health Care Provider')] = 'Visited a Health Care Provider'
