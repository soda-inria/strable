"""Preprocess HIFLD oil and natural gas platform dataset.
The task is to predict WATERDEPTH (regression) 
"""
...
filename = 'HIFLD/Oil_and_Natural_Gas_Platforms_3126453086462845921.csv'
...
drop_col = []
# Leakage (related to shapes)
drop_col.append('DISTLAND')
drop_col.append('LATITUDE')
drop_col.append('LONGITUDE')
drop_col.append('x')
drop_col.append('y')
# Highly related
...
data_filename = 'oil-natural-gas-platform'
