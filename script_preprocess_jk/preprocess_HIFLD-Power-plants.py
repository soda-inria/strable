"""Preprocess HIFLD power plants dataset.
The task is to predict NAMPLT_CAP (regression).
"""
...
filename = 'HIFLD/Power_Plants_gdb_1241944218131586886.xlsx'
...
# Leakage
# Highly related
drop_col += [col for col in data.columns if 'CAP' in col]
